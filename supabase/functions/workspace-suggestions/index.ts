...
- For relationshipScore, return exactly one of "Very Bad", "Bad", "Neutral", "Good", or "Very Good" whenever the user explicitly states or clearly describes how good or bad the relationship is. Do not leave this field empty when relationship quality is expressed in ordinary language. Map hostile, harmful, or extremely distrustful to Very Bad; tense, difficult, poor, or low-trust to Bad; mixed, limited, neither good nor bad, or merely professional to Neutral; cooperative, positive, helpful, or trusting to Good; and exceptionally supportive, close, or highly trusted to Very Good. Otherwise leave it empty.
